...
public class TablesAdapter extends RecyclerView.Adapter<TablesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TablesAdapter.MyViewHolder holder, int position) {
        ...
        }else if (tableModels.get(position).getTableStatus().equals("Active") || tableModels.get(position).getTableStatus().equals("Reserved")){

            if(tableModels.get(position).getTableStatus().equals("Active")) {
